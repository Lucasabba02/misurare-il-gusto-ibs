...
Infine, un'ultima analisi che è stata fatta riguarda la correlazione tra linguaggio promozionale e i generi. Per comodità sono stati scelti 5 macro-generi rappresentativi della TOP100: narrativa, bambini e ragazzi, saggistica e cultura, scienze e salute, casa e tempo libero. Per comodità grafica sono stati elaborati sia una heatmap che un grafico a barre. 
<img width="1000" height="590" alt="image" src="https://github.com/user-attachments/assets/4dce0a45-3267-4d58-a352-359764f835d7" />
<img width="1288" height="690" alt="image" src="https://github.com/user-attachments/assets/e8eb3906-85b9-4891-8747-b7c411777696" />


## FASE 4: CONCLUSIONI PERSONALI
Al termine di questa analisi, dopo aver osservato attentamente i dati ottenuti e i grafici con le loro correlazioni, possiamo giungere a delle conclusioni. Un pattern sulla correlazione tra la descrizione promozionale e la posizione in classifica dei libri è visibile, ma non è particolarmente rilevante: se è pur vero che la presenza nelle descrizioni di riferimenti a premi, riconoscimenti e successo, a parole riguardanti la novità e l'attesa, e al coinvolgimento del lettore, in alcuni casi è tripla nella top 25, rispetto alla restante top 26-100, non dobbiamo farci ingannare dai grafici; la ricorrenza dei vari termini infatti è più vicina di quanto sembri. 
...
Anche se presenta numeri bassi in senso assoluto, noterei anche la presenza di lessico relativo a premi e riconoscimenti nella parte alta della classifica, indicativo di una generale tendenza dei libri più premiati e riconosciuti a posizionarsi nelle parti alte della classifica.
Un'ultima analisi, forse quella più interessante, va compiuta sui dati relativi alla correlazione tra linguaggio promozionale e genere. Da questi dati emerge che la narrativa fa largo uso di tutte le categorie descrittive prese in considerazione e presenta il profilo più bilanciato. I libri relativi a scienza e salute e a saggistica e cultura fanno ampio ricorso a un linguaggio di novità e attesa: si potrebbe presumere che sia dovuto alla novità delle ricerche scientifiche o del modo in cui è stato trattato dall'autore un determinato argomento. In particolar modo, i libri di scienza e salute tentano di coinvolgere direttamente il lettore: potremmo dedurre che i libri di salute nello specifico siano indirizzati a un determinato lettore e che quindi sia inevitabile l'utilizzo di tale linguaggio descrittivo. Anche i libri per bambini e ragazzi emergono per l'uso di linguaggio legato al coinvolgimento del lettore: anche qui abbastanza inevitabile, dato che l'obiettivo è coinvolgere il "piccolo" lettore o il genitore che deve acquistare il prodotto. 
